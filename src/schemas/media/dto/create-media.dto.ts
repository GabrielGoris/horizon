...
export const createMediaSchema = z.object({
  ...
  type: z.enum(["animes", "movies", "games", "books"] as const),
  media_format: z.enum(["movie", "series"] as const).optional(),
  ...
  status: z.enum(["queue", "in_progress", "incomplete", "dropped", "complete", "want_to_buy", "unplanned"] as const),
  ...
  hours_played: z.string().optional(),
